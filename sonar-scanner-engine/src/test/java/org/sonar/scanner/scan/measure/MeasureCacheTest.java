...
public class MeasureCacheTest extends AbstractCachesTest {
  ...
  public void should_add_measure() {
    ...
    measureCache.put(COMPONENT_KEY, m);
  ...
  public void should_get_measures() {
    ...
    measureCache.put(projectKey, mProj);
