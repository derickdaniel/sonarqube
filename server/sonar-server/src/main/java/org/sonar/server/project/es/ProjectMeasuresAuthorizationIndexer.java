...
public class ProjectMeasuresAuthorizationIndexer extends BaseIndexer {

  private final DbClient dbClient;

  public ProjectMeasuresAuthorizationIndexer(DbClient dbClient, EsClient esClient) {
    super(esClient, 0L, ProjectMeasuresIndexDefinition.INDEX_PROJECT_MEASURES, ProjectMeasuresIndexDefinition.TYPE_AUTHORIZATION, ProjectMeasuresIndexDefinition.FIELD_ANALYSED_AT);
